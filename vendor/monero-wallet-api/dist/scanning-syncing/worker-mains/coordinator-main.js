...
export async function coordinatorMainWorker(scan_settings_path, pathPrefix, cpuPorts) {
    log("coordinatorMainWorker", "cpuPorts=" + cpuPorts?.length);
    shutdownController = new AbortController();
    try {
        const gen = coordinatorMainMultithreaded(scan_settings_path, pathPrefix, cpuPorts, shutdownController.signal);

...
export function makeEscrowContext(context_index) {
...
export function parseEscrowContext(input) {
 ...
 */
export function deriveEscrowViewpairCommsSecret(bip39_secret) {
...
export function escrowViewPairECDHgetPublicKey(vp_comms_secret) {
 ...
 */
export async function performEscrowViewPairECDH(alice_sk, bob_pk) {
    const txt = new TextEncoder();
